...
class Ui_Tester(object):
    ...
    def setupUi(self, Tester):
        ...
        #self.actionCouleur.triggered.connect(self.choixCouleur())
    ...
    def retranslateUi(self, Tester):
        ...
        #self.label.setText(_translate("Tester",
        #                              "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Remerciements</span></p></body></html>"))
        ...
        self.menuCouleur.setTitle(_translate("Tester", "Modifier la couleur"))
        self.menuFont.setTitle(_translate("Tester", "Modifier le style"))
        ...
        self.actionStyle.setText(_translate("Tester", "Modifier le style"))
        self.actionStyleDefault.setText(_translate("Tester", "Style par défaut"))

        self.actionCouleur.setText(_translate("Tester", "Palette de couleurs"))
        self.actionMode_clair.setText(_translate("Tester", "Mode clair"))
        self.actionMode_sombre.setText(_translate("Tester", "Mode sombre"))
